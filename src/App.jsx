...
export default function App() {
  ...
  const CV_DRIVE_URL = "https://drive.google.com/file/d/1O6euXZFSGtv8Jj560_0Hw5jWkxj4ODb2/view?usp=sharing";
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-cyan-500 selection:text-slate-950">
      ...
      {/* Toast Notification */}
      {toastMessage && (
        <div className="fixed bottom-6 right-6 z-50 bg-cyan-950 border border-cyan-500 text-cyan-200 px-5 py-3 rounded-lg shadow-2xl flex items-center gap-3 animate-bounce">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <a href="#home" className="flex items-center gap-2 group">
              <div className="w-9 h-9 rounded-lg bg-cyan-500/10 border border-cyan-500/30 flex items-center justify-center text-cyan-400 group-hover:bg-cyan-500/20 transition-all">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-slate-400 font-mono">SQA / SDET ENGINEER</span>
              </div>
            </a>
          ...
          <div className="lg:hidden bg-slate-900/95 border-b border-slate-800 px-4 pt-2 pb-6 space-y-2">
            {[
              ...
              <a
                ...
                className="block px-3 py-2 rounded-md text-sm font-medium text-slate-300 hover:bg-slate-800 hover:text-cyan-400"
              >
                {item.label}
              </a>
            ))}
      ...
      {/* Hero Section */}
      <section id="home" className="relative pt-12 pb-20 md:py-24 overflow-hidden border-b border-slate-800/60">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900 border border-slate-700/80 text-cyan-400 text-xs font-mono">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-4">
                ...
                <button
                  onClick={handleDownloadCV}
                  className="px-6 py-3 rounded-lg bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700 font-semibold text-sm flex items-center gap-2 transition-all hover:border-slate-600 cursor-pointer"
                >
              ...
              <div className="pt-4 flex items-center gap-6 border-t border-slate-800/80">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-slate-400 hover:text-cyan-400 transition-colors flex items-center gap-1 text-xs font-mono"
                >
                ...
                <button
                  ...
                  className="text-slate-400 hover:text-cyan-400 transition-colors flex items-center gap-1 text-xs font-mono cursor-pointer"
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6 shadow-2xl relative overflow-hidden">
                <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-mono text-cyan-400 font-bold uppercase">QA Profile Overview</span>
                  </div>
                  <span className="text-[10px] font-mono bg-emerald-950 text-emerald-400 border border-emerald-800 px-2 py-0.5 rounded">Active Status</span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {PROFILE.stats.map((st, i) => (
                    <div key={i} className="p-3 rounded-xl bg-slate-950 border border-slate-800/80">
                      ...
                      <div className="text-sm sm:text-base font-bold text-slate-100 mt-1 font-mono">{st.value}</div>
                    </div>
                  ))}
                </div>

                <div className="p-4 rounded-xl bg-cyan-950/30 border border-cyan-800/40 text-xs text-cyan-200 font-mono space-y-2">
                  <div className="font-bold flex items-center gap-1.5 text-cyan-300">
                    <Zap className="w-4 h-4 text-cyan-400" /> SQA Core Strengths:
                  </div>
      ...
      {/* About Section */}
      <section id="about" className="py-20 border-b border-slate-800/60 bg-slate-950/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center mb-12">
            <span className="text-xs font-mono text-cyan-400 tracking-wider uppercase bg-cyan-500/10 px-3 py-1 rounded-full border border-cyan-500/20 mb-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-4 text-slate-300 text-sm sm:text-base leading-relaxed">
              <p>
                I am a Computer Science graduate from <span className="text-white font-semibold">BRAC University</span> with specialized hands-on training in Full-Stack SQA and Software Test Automation from <span className="text-cyan-400 font-semibold">Road to SDET Academy</span>.
              </p>
              <p>
      ...
      <section id="skills" className="py-20 border-b border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white">Skills &amp; Testing Capabilities</h2>
            <div className="w-12 h-1 bg-cyan-500 rounded mt-3" />
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
            ...
            <div className="relative w-full sm:w-64">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-1.5 rounded-lg bg-slate-900 border border-slate-800 text-slate-200 text-xs focus:outline-none focus:border-cyan-500 font-mono"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredSkills.map((cat) => (
              <div key={cat.id} className="bg-slate-900 border border-slate-800 rounded-2xl p-6 hover:border-slate-700 transition-all flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {cat.skills.map((skill, sIdx) => (
                      <span
                        key={sIdx}
                        className="px-2.5 py-1 rounded-md bg-slate-950 border border-slate-800/80 text-xs text-slate-300 font-mono hover:border-cyan-500/50 hover:text-cyan-300 transition-colors"
                      >
                        {skill}
                      </span>
                    ))}
      ...
      {/* Projects Section */}
      <section id="projects" className="py-20 border-b border-slate-800/60 bg-slate-950/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white">Projects &amp; QA Test Work</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {PROJECTS.map((proj) => (
              <div
                key={proj.id}
                className={`bg-slate-900 border rounded-2xl p-6 flex flex-col justify-between transition-all group hover:scale-[1.01] ${
                  proj.isFlagship
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      ...
                      <p className="text-xs font-mono text-slate-400 mt-1">{proj.role}</p>
                    </div>
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      {proj.githubUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="p-2 rounded-lg bg-slate-950 border border-slate-800 text-slate-400 hover:text-white hover:border-slate-600"
                  ...
                  <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">{proj.summary}</p>

                  <div className="space-y-2 pt-2">
                    <span className="text-[11px] font-mono text-cyan-400 uppercase tracking-wider block">Testing Focus:</span>
                    <div className="flex flex-wrap gap-1.5">
                      {proj.testingFocus.map((tf, idx) => (
                        <span key={idx} className="text-[10px] font-mono px-2 py-0.5 rounded bg-cyan-950/60 border border-cyan-800/60 text-cyan-200">
                          ✓ {tf}
                        </span>
                      ))}
                    </div>
                ...
                <div className="pt-6">
                  <button
                    ...
                    className="w-full py-2.5 rounded-lg bg-slate-950 hover:bg-cyan-500 hover:text-slate-950 border border-slate-800 hover:border-cyan-500 text-slate-300 font-mono text-xs font-bold transition-all flex items-center justify-center gap-2"
                  >
      ...
      {/* QA Lab Section */}
      <section id="qalab" className="py-20 border-b border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white">QA LAB</h2>
            <p className="text-slate-400 text-sm mt-2 max-w-xl">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 border-b border-slate-800 bg-slate-950">
              {QA_LAB_DOMAINS.map((domain) => (
                <button
                  key={domain.id}
                  onClick={() => setActiveLabTab(domain.id)}
                  className={`p-4 text-left transition-all flex items-center gap-3 border-r border-slate-800 last:border-r-0 ${
            ...
            <div className="p-6 md:p-8 font-mono">
              ...
              {activeLabTab === 'api' && (
                <div className="space-y-6">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-4">
                    <div>
                      <span className="text-xs text-cyan-400 font-bold uppercase">Postman / Newman / Axios Runner Simulator</span>
                      <h3 className="text-lg font-bold text-white mt-1">REST API &amp; Auth Assertion Workbench</h3>
                    </div>
                    
                    <button
                      onClick={runApiSimulation}
                      disabled={apiSimStatus === 'running'}
                      className="px-4 py-2 rounded-lg bg-emerald-500 hover:bg-emerald-400 disabled:bg-slate-800 text-slate-950 font-bold text-xs flex items-center gap-2 transition-all cursor-pointer"
                    >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 text-center text-[11px]">
                    {[
                      ...
                      >
                        <div className="font-bold text-xs text-slate-400">Step {item.step}</div>
                        <div className="font-bold mt-1 text-slate-200">{item.label}</div>
                  ...
                  <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 text-xs space-y-1.5 font-mono">
                    ...
                    <div className="text-slate-300">$ newman run blogspace_postman_collection.json -e staging_env.json</div>
                    <div className="text-emerald-400">✓ POST /api/auth/register-otp [200 OK, 112ms] - Assert OTP Sent</div>
                    <div className="text-emerald-400">✓ POST /api/auth/login [200 OK, 98ms] - Assert JWT Token Returned</div>
                    <div className="text-emerald-400">✓ GET /api/admin/blogs [403 Forbidden, 45ms] - Assert Guest RBAC Blocked</div>
                    <div className="text-emerald-400">✓ PUT /api/user/avatar [422 Unprocessable Entity, 62ms] - Assert Invalid File Ext Rejected</div>
                    {apiSimStatus === 'success' && (
                      <div className="pt-2 text-cyan-400 border-t border-slate-800 font-bold">
                        ┌────────────────────────────────────────┐<br />
              ...
              {activeLabTab === 'ui' && (
                <div className="space-y-6">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-4">
                    <div>
                      <span className="text-xs text-cyan-400 font-bold uppercase">Selenium Python Web Driver</span>
                      <h3 className="text-lg font-bold text-white mt-1">Page Object Model (POM) Automation Mechanics</h3>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-3 text-xs">
                    {[
                      ...
                      >
                        ...
                        <div className="text-[10px] text-cyan-400 mt-1 font-mono">{st.code}</div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 text-xs font-mono space-y-1">
                    ...
                    <div className="text-purple-400">def <span className="text-blue-300">test_add_to_cart_and_checkout</span>(self):</div>
                    <div className="text-slate-300 pl-4">self.login_page.login("user@test.com", "password123")</div>
                    <div className="text-slate-300 pl-4">self.catalog.search_product("MacBook Air")</div>
                    <div className="text-slate-300 pl-4">self.catalog.click_add_to_cart()</div>
                    <div className="text-emerald-400 pl-4">assert self.cart.get_item_count() == 1</div>
                  </div>
                </div>
              )}
              ...
              {activeLabTab === 'db' && (
                <div className="space-y-6">
                  <div className="border-b border-slate-800 pb-4">
                    <span className="text-xs text-cyan-400 font-bold uppercase">MySQL &amp; Sequelize Verification</span>
                    <h3 className="text-lg font-bold text-white mt-1">Schema Integrity &amp; Referential Constraint Testing</h3>
                  </div>
                  ...
                  <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 text-xs font-mono space-y-2">
                    {dbQueryTab === 'users' && (
                      <>
                        ...
                        <div className="text-cyan-300">SELECT id, email, is_verified, otp_hash FROM users WHERE email = 'testuser@domain.com';</div>
                        <div className="text-emerald-400">-- Result: 1 Row Returned [is_verified = 1, otp_hash = NULL] &rarr; PASSED</div>
                      </>
                    )}
                    {dbQueryTab === 'orders' && (
                      <>
                        <div className="text-slate-500">-- Cascade Integrity Check: Ensure no orphaned order records</div>
                        <div className="text-cyan-300">SELECT o.id FROM orders o LEFT JOIN users u ON o.user_id = u.id WHERE u.id IS NULL;</div>
                        <div className="text-emerald-400">-- Result: 0 Rows Returned (No orphaned entries found) &rarr; PASSED</div>
                      </>
                    )}
                    {dbQueryTab === 'constraints' && (
                      <>
                        <div className="text-slate-500">-- Duplicate Constraint Assert</div>
                        <div className="text-cyan-300">INSERT INTO users (email) VALUES ('existing_user@domain.com');</div>
                        <div className="text-amber-400">-- ERROR 1062 (23000): Duplicate entry 'existing_user@domain.com' for key 'users.email' &rarr; PASSED</div>
                      </>
                    )}
                  </div>
                </div>
              ...
              {activeLabTab === 'perf' && (
                <div className="space-y-6">
                  <div className="border-b border-slate-800 pb-4">
                    <span className="text-xs text-cyan-400 font-bold uppercase">JMeter Performance Principles</span>
                    <h3 className="text-lg font-bold text-white mt-1">Load &amp; Stress Metrics Analysis</h3>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-4 rounded-xl bg-slate-950 border border-slate-800">
                      <div className="text-xs text-slate-400">Load Testing</div>
                      <div className="text-lg font-bold text-cyan-400 mt-1">50 Concurrent Threads</div>
                      <div className="text-[11px] text-slate-500 mt-1">Sustained throughput under normal traffic limits.</div>
                    </div>

                    <div className="p-4 rounded-xl bg-slate-950 border border-slate-800">
                      <div className="text-xs text-slate-400">Stress Testing</div>
                      <div className="text-lg font-bold text-amber-400 mt-1">Ramp-Up Peak Load</div>
                      <div className="text-[11px] text-slate-500 mt-1">Identifying system breaking point &amp; recovery behavior.</div>
                    </div>

                    <div className="p-4 rounded-xl bg-slate-950 border border-slate-800">
                      <div className="text-xs text-slate-400">Target Response Benchmark</div>
                      <div className="text-lg font-bold text-emerald-400 mt-1">Under 200ms Latency</div>
      ...
      <section id="workflow" className="py-20 border-b border-slate-800/60 bg-slate-950/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white">Testing Workflow &amp; Quality Pipeline</h2>
            <p className="text-slate-400 text-sm mt-2 max-w-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {STLC_STEPS.map((step) => (
              <div
                key={step.num}
                className="bg-slate-900/80 border border-slate-800 rounded-xl p-5 hover:border-cyan-500/40 transition-all flex flex-col justify-between group"
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-2xl font-black font-mono text-slate-700 group-hover:text-cyan-400 transition-colors">
                      {step.num}
                    </span>
                ...
                <div className="mt-4 pt-3 border-t border-slate-800/80 text-[11px] font-mono text-cyan-400/90">
                  Tools: <span className="text-slate-400">{step.tools}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="certification" className="py-20 border-b border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white">Professional Certification</h2>
            <div className="w-12 h-1 bg-cyan-500 rounded mt-3" />
          </div>

          <div className="max-w-3xl mx-auto bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-8 relative overflow-hidden shadow-2xl">
            <div className="absolute top-0 right-0 translate-x-8 -translate-y-8 w-40 h-40 bg-cyan-500/10 rounded-full blur-2xl pointer-events-none" />

            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div className="space-y-2">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-950 border border-emerald-800 text-emerald-400 text-xs font-mono">
                  <Award className="w-3.5 h-3.5" /> Certified Quality Assurance Specialist
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-white">{PROFILE.certification.title}</h3>
                <p className="text-sm font-mono text-slate-400">
                  {PROFILE.certification.academy} &bull; {PROFILE.certification.hours}
                </p>
                <div className="text-xs font-mono text-cyan-400">Completed: {PROFILE.certification.date}</div>
              </div>
            ...
            <div className="mt-6 pt-6 border-t border-slate-800 space-y-3">
              <span className="text-xs font-mono text-slate-400 uppercase tracking-wider block">Core Certification Modules:</span>
              <div className="flex flex-wrap gap-2">
                {PROFILE.certification.topics.map((topic, idx) => (
                  <span key={idx} className="px-3 py-1 rounded-md bg-slate-950 border border-slate-800 text-xs font-mono text-slate-300">
                    ✓ {topic}
                  </span>
                ))}
              </div>
      ...
      {/* Education Section */}
      <section id="education" className="py-20 border-b border-slate-800/60 bg-slate-950/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white">Education &amp; Research Thesis</h2>
            <div className="w-12 h-1 bg-cyan-500 rounded mt-3" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-5 bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white">{PROFILE.education.degree}</h3>
                  <p className="text-xs font-mono text-slate-400">{PROFILE.education.institution}</p>
                </div>
              </div>
              ...
              <div className="pt-2 border-t border-slate-800/80 space-y-2">
                <div className="flex justify-between items-center text-xs font-mono">
                  ...
                  <span className="text-slate-200">{PROFILE.education.location}</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-mono text-cyan-400 uppercase tracking-wider">Undergraduate Thesis</span>
              </div>
              ...
              <div className="pt-3 border-t border-slate-800 text-[11px] font-mono text-slate-500 flex items-center justify-between">
                ...
                <span className="text-emerald-400">BRAC University Defended</span>
              </div>
            </div>
      ...
      <section id="contact" className="py-20 border-b border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white">Let's build better software.</h2>
            <p className="text-slate-400 text-sm mt-2 max-w-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6">
                <h3 className="text-lg font-bold text-white font-mono">Contact Details</h3>
                ...
                <div className="space-y-4 text-xs font-mono">
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-slate-950 border border-slate-800">
                    ...
                    <div className="truncate">
                      ...
                      <button
                        onClick={handleEmailClick}
                        className="text-slate-200 hover:text-cyan-400 transition-colors cursor-pointer text-left truncate font-semibold block"
                      >
                        {PROFILE.email}
                      </button>
                    </div>
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-slate-950 border border-slate-800">
                    ...
                    <div>
                      ...
                      <a href={`tel:${PROFILE.phone}`} className="text-slate-200 hover:text-cyan-400 transition-colors font-semibold">
                        {PROFILE.phone}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-slate-950 border border-slate-800">
                    ...
                    <div className="truncate">
                      ...
                      <a href={PROFILE.linkedin} target="_blank" rel="noreferrer" className="text-slate-200 hover:text-cyan-400 transition-colors truncate font-semibold block">
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-slate-950 border border-slate-800">
                    ...
                    <div className="truncate">
                      ...
                      <a href={PROFILE.github} target="_blank" rel="noreferrer" className="text-slate-200 hover:text-cyan-400 transition-colors truncate font-semibold block">
      ...
      {/* Footer Section */}
      <footer className="relative bg-slate-950 border-t border-slate-800/80 text-slate-400 text-xs font-mono py-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-slate-500">
            <div className="flex items-center gap-2">
              <span>&copy; {new Date().getFullYear()} <strong className="text-slate-300 font-semibold">MD. Meherab Hossain Nowshad</strong>. All Rights Reserved.</span>
            </div>

            <div className="flex items-center gap-3 font-mono text-[10px] text-slate-400">
              <span className="px-2 py-0.5 rounded bg-slate-900 border border-slate-800/80">
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-2xl w-full p-6 space-y-6 max-h-[90vh] overflow-y-auto shadow-2xl relative">
            <div className="flex items-start justify-between">
              <div>
                <span className="text-[10px] font-mono text-cyan-400 uppercase tracking-wider">Project QA Deep Dive</span>
                <h3 className="text-xl font-bold text-white mt-1">{selectedProject.title}</h3>
                <p className="text-xs font-mono text-slate-400">{selectedProject.role}</p>
              </div>
              <button
            ...
            <p className="text-xs sm:text-sm text-slate-300">{selectedProject.qaBreakdown?.overview || selectedProject.summary}</p>

            <div className="space-y-3 pt-2">
              <h4 className="text-xs font-bold font-mono text-cyan-400 uppercase">Tested Scenarios &amp; Breakdown</h4>
              <div className="space-y-2">
                {selectedProject.qaBreakdown?.scenariosTested?.map((sc, idx) => (
                  <div key={idx} className="p-3 rounded-lg bg-slate-950 border border-slate-800 text-xs font-mono">
                    <span className="text-white font-bold block">{sc.area}:</span>
                    <span className="text-slate-400 text-[11px] mt-0.5 block">{sc.detail}</span>
                  </div>
                ))}
              </div>
            </div>
